                          ...
                          size_t srcSize)
{
    ...
    {
        int const cSize = LZ4_compress_fast_continue(&LZ4_cState, (const char *)srcBuff, (char *)compressedBuff,
                                                     (int)srcSize, (int)compressedBuffCapacity, acceleration);
        ...
        {
            int const dSize = LZ4_decompress_safe_continue(&LZ4_dState, (const char *)compressedBuff,
                                                           (char *)resultBuff, cSize, (int)resultBuffCapacity);
...
static void roundTripCheck(const void *srcBuff, size_t srcSize)
{
    ...
    roundTripTest(rBuff, cBuffSize, cBuff, cBuffSize, srcBuff, srcSize);
