...
const char source[] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod\n"
...
int main(void)
{
    ...
    for (i = cmpSize; i < cmpSize + 10; ++i)
    {
        int result = LZ4_decompress_safe_partial_usingDict(cmpBuffer, outBuffer, i, srcLen, BUFFER_SIZE,
                                                           outBuffer - smallSize, smallSize);
        if ((result < 0) || (result != srcLen) || memcmp(source, outBuffer, (size_t)srcLen))
        {
    ...
    {
        int result =
            LZ4_decompress_safe_partial_usingDict(cmpBuffer, outBuffer, i, srcLen, BUFFER_SIZE, buffer, largeSize);
        if ((result < 0) || (result != srcLen) || memcmp(source, outBuffer, (size_t)srcLen))
        {
    ...
    {
        int result =
            LZ4_decompress_safe_partial_usingDict(cmpBuffer, outBuffer, i, srcLen, BUFFER_SIZE, smallDict, smallSize);
        if ((result < 0) || (result != srcLen) || memcmp(source, outBuffer, (size_t)srcLen))
        {
    ...
    {
        int result =
            LZ4_decompress_safe_partial_usingDict(cmpBuffer, outBuffer, i, srcLen, BUFFER_SIZE, largeDict, largeSize);
        if ((result < 0) || (result != srcLen) || memcmp(source, outBuffer, (size_t)srcLen))
        {
