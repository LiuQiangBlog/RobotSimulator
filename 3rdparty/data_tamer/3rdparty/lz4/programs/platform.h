 ...
 ************************************************************** */
#if !defined(_WIN32) &&                                                                                   \
    (defined(__unix__) || defined(__unix) || (defined(__APPLE__) && defined(__MACH__)) /* UNIX-like OS */ \
    ...
    defined(__MidnightBSD__) /* BSD distros */                                                          \
    || defined(__HAIKU__)
...
#define SET_BINARY_MODE(file)                            \
    {                                                    \
        int unused = _setmode(_fileno(file), _O_BINARY); \
        (void)unused;                                    \
    }
