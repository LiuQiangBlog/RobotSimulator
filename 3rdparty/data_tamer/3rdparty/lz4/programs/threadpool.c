...
static DWORD WINAPI WorkerThread(LPVOID lpParameter)
{
    ...
    while (GetQueuedCompletionStatus(pool->completionPort, &bytesTransferred, &completionKey, &overlapped, INFINITE))
    {
...
void TPool_submitJob(TPool *pool, void (*job_function)(void *), void *arg)
{
    ...
    PostQueuedCompletionStatus(pool->completionPort, 0, /* Bytes transferred not used */
...
static void TPool_submitJob_internal(TPool *ctx, void (*job_function)(void *), void *arg)
{
    TPool_job job;
