...
#define RETURN_ERROR_IF(cond, err, ...)                                                                    \
    ...
    {                                                                                                      \
        if (cond)                                                                                          \
        {                                                                                                  \
            RAWLOG(3, "%s:%d: ERROR!: check %s failed, returning %s", __FILE__, __LINE__, ERR_QUOTE(cond), \
                   ERR_QUOTE(ERROR(err)));                                                                 \
            _FORCE_HAS_FORMAT_STRING(__VA_ARGS__);                                                         \
...
#define FORWARD_IF_ERROR(err, ...)                                                                     \
    ...
    {                                                                                                  \
        ...
        {                                                                                              \
            RAWLOG(3, "%s:%d: ERROR!: forwarding error in %s: %s", __FILE__, __LINE__, ERR_QUOTE(err), \
