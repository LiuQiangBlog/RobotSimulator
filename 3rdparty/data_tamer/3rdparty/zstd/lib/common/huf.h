...
/* this is a private definition, just exposed for allocation and strict aliasing purpose. never EVER access its members
 * directly */
...
unsigned
HUF_optimalTableLog(unsigned maxTableLog,
                    size_t srcSize,
                    ...
                    int flags); /* table is used as scratch space for building and testing tables, not a return value */
