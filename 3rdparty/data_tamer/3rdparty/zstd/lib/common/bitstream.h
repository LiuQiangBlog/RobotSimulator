...
FORCE_INLINE_TEMPLATE BitContainerType BIT_getMiddleBits(BitContainerType bitContainer,
                                                         U32 const start,
                                                         U32 const nbBits)
{
...
FORCE_INLINE_TEMPLATE BitContainerType BIT_lookBits(const BIT_DStream_t *bitD, U32 nbBits)
{
    ...
    return BIT_getMiddleBits(bitD->bitContainer, (sizeof(bitD->bitContainer) * 8) - bitD->bitsConsumed - nbBits,
                             nbBits);
#else
