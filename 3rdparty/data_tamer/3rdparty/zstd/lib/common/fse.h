...
#define FSE_DECOMPRESS_WKSP_SIZE_U32(maxTableLog, maxSymbolValue)                                         \
    (FSE_DTABLE_SIZE_U32(maxTableLog) + 1 + FSE_BUILD_DTABLE_WKSP_SIZE_U32(maxTableLog, maxSymbolValue) + \
 ...
 * `FSE_DECOMPRESS_WKSP_SIZE_U32(maxLog, maxSymbolValue)`. Set bmi2 to 1 if your CPU supports BMI2 or 0 if it doesn't */
