...
static void countFreqs(const char *words[], size_t nbWords, const int *weights, size_t nbWeights)
{
    unsigned total = 0;
    size_t w;
    for (w = 0; w < nbWords; w++)
...
static void init_word_distrib(const char *words[], size_t nbWords, const int *weights, size_t nbWeights)
{
    size_t w, d = 0;
