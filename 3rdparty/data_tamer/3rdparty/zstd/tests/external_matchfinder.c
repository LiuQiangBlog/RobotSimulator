...
static size_t simpleSequenceProducer(void *sequenceProducerState,
                                     ...
                                     size_t windowSize)
{
    ...
    while (ip + MLS < iend)
    {
        ...
        if (matchIndex != BADIDX)
        {
            ...
            if (matchLen >= ZSTD_MINMATCH_MIN)
            {
                ...
                ZSTD_Sequence const seq = {offset, litLen, matchLen, 0};
    ...
    {
        ZSTD_Sequence const finalSeq = {0, (U32)(iend - anchor), 0, 0};
                               ...
                               size_t windowSize)
{
    ...
    case EMF_LOTS_OF_SEQS:
        return simpleSequenceProducer(sequenceProducerState, outSeqs, outSeqsCapacity, src, srcSize, dict, dictSize,
