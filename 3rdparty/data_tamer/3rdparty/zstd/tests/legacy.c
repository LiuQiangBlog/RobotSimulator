...
/* Consists of the "EXPECTED" string compressed with default settings on
    ...
    - v0.8.0
*/
const char *const COMPRESSED = "\x24\xB5\x2F\xFD\x00\x00\x00\xBB\xB0\x02\xC0\x10\x00\x1E\xB0\x01"
...
const char *const EXPECTED = "snowden is snowed in / he's now then in his snow den / when does the snow end?\n"
