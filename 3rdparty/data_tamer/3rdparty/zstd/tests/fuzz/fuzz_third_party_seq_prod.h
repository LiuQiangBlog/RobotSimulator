...
extern "C"
{
     ...
     *   - Build the fuzzer binaries with options corresponding to the flags you chose. Use --custom-seq-prod= to pass
     * in your object file:
     *     `./fuzz.py build all --enable-fuzzer --enable-asan --enable-ubsan --cc clang --cxx clang++
     * --custom-seq-prod=your_object.o`
     *
     ...
     *   $ python3 ./fuzz.py build all --enable-fuzzer --enable-asan --enable-ubsan --cc clang --cxx clang++
     * --custom-seq-prod=seq_prod_fuzz_example/example_seq_prod.o $ python3 ./fuzz.py libfuzzer simple_round_trip
     */
