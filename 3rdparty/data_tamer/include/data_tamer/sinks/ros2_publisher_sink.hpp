...
public:
    ...
    void create_publishers(NodeT &node, const std::string &topic_prefix)
    {
        ...
        schema_publisher_ =
            node->template create_publisher<data_tamer_msgs::msg::Schemas>(topic_prefix + "/schemas", schemas_qos);
        data_publisher_ =
            node->template create_publisher<data_tamer_msgs::msg::Snapshot>(topic_prefix + "/data", data_qos);
    }
