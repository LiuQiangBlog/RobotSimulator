...
#ifndef __data_channel_hpp__
#define __data_channel_hpp__
...
uint32_t data_channel::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t data_channel::getHash()
{
...
uint32_t data_channel::_getEncodedSizeNoHash() const
{
    uint32_t enc_size = 0;
