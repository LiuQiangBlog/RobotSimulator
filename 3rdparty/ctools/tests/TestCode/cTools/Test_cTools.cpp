...
int Test_cTools_Vec2_run_test(const std::string &vTestCode)
{
    ...
    {
        bool vb = (v != ct::vec2<T>((T)6.0, (T)2.0)) && (v != ct::vec2<T>((T)5.0, (T)3.0)) &&
...
int Test_cTools_Vec3_run_test(const std::string &vTestCode)
{
    ...
    {
        const auto &vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.5) && is_equal(v.x, (T)6.0) &&
            is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.5))
            return 0;
    }
    else if (vTestCode.find(".Vec3.post--") != std::string::npos)
    {
        const auto &vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.5) && is_equal(v.x, (T)4.0) &&
            is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.5))
            return 0;
    }
    else if (vTestCode.find(".Vec3.pre++") != std::string::npos)
    {
        const auto &vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)7.5) && is_equal(v.x, (T)6.0) &&
            is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.5))
            return 0;
    }
    else if (vTestCode.find(".Vec3.pre--") != std::string::npos)
    {
        const auto &vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)5.5) && is_equal(v.x, (T)4.0) &&
            is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.5))
            return 0;
    }
    ...
    {
        bool vb = (v != ct::vec3<T>((T)6.0, (T)2.0, (T)6.5)) && (v != ct::vec3<T>((T)5.0, (T)3.0, (T)6.5)) &&
                  (v != ct::vec3<T>((T)6.0, (T)3.0, (T)6.5)) && (v != ct::vec3<T>((T)2.0, (T)1.0, (T)6.5));
        if (vb)
            return 0;
    }
    else if (vTestCode.find(".Vec3.*=a") != std::string::npos)
...
int Test_cTools_Vec3_run_test<bool>(const std::string &vTestCode)
{
    ...
    {
        if ((v != ct::bvec3(false, true, true)) && (v != ct::bvec3(true, true, true)) &&
...
int Test_cTools_signed_integer_Vec3_run_test(const std::string &vTestCode)
{
    ...
    {
        const auto &vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.0) && is_equal(v.x, (T)6.0) &&
            is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.0))
            return 0;
    }
    else if (vTestCode.find(".Vec3.post--") != std::string::npos)
    {
        const auto &vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)6.0) && is_equal(v.x, (T)4.0) &&
            is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.0))
            return 0;
    }
    else if (vTestCode.find(".Vec3.pre++") != std::string::npos)
    {
        const auto &vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)7.0) && is_equal(v.x, (T)6.0) &&
            is_equal(v.y, (T)3.0) && is_equal(v.z, (T)7.0))
            return 0;
    }
    else if (vTestCode.find(".Vec3.pre--") != std::string::npos)
    {
        const auto &vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)5.0) && is_equal(v.x, (T)4.0) &&
            is_equal(v.y, (T)1.0) && is_equal(v.z, (T)5.0))
            return 0;
    }
    else if (vTestCode.find(".Vec3.+=a") != std::string::npos)
    ...
    {
        bool vb = (v != ct::vec3<T>((T)6.0, (T)2.0, (T)6.0)) && (v != ct::vec3<T>((T)5.0, (T)3.0, (T)6.0)) &&
                  (v != ct::vec3<T>((T)6.0, (T)3.0, (T)6.0)) && (v != ct::vec3<T>((T)2.0, (T)1.0, (T)6.0));
        if (vb)
            return 0;
    }
    else if (vTestCode.find(".Vec3.*=a") != std::string::npos)
...
int Test_cTools_Vec4_run_test(const std::string &vTestCode)
{
    ...
    {
        const auto &vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.5) && is_equal(vc.w, (T)6.5) &&
            is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)5.5) && is_equal(v.w, (T)7.5))
            return 0;
    }
    else if (vTestCode.find(".Vec4.post--") != std::string::npos)
    {
        const auto &vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.5) && is_equal(vc.w, (T)6.5) &&
            is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)3.5) && is_equal(v.w, (T)5.5))
            return 0;
    }
    else if (vTestCode.find(".Vec4.pre++") != std::string::npos)
    {
        const auto &vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)5.5) && is_equal(vc.w, (T)7.5) &&
            is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)5.5) && is_equal(v.w, (T)7.5))
            return 0;
    }
    else if (vTestCode.find(".Vec4.pre--") != std::string::npos)
    {
        const auto &vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)3.5) && is_equal(vc.w, (T)5.5) &&
            is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)3.5) && is_equal(v.w, (T)5.5))
            return 0;
    }
    ...
    {
        bool vb =
            (v != ct::vec4<T>((T)6.0, (T)2.0, (T)6.5, (T)2.5)) && (v != ct::vec4<T>((T)5.0, (T)3.0, (T)6.5, (T)2.5)) &&
...
int Test_cTools_Vec4_run_test<bool>(const std::string &vTestCode)
{
    ...
    {
        if ((v != ct::bvec4(false, true, true, false)) && (v != ct::bvec4(true, true, true, false)) &&
...
int Test_cTools_signed_integer_Vec4_run_test(const std::string &vTestCode)
{
    ...
    {
        const auto &vc = v++;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.0) && is_equal(vc.w, (T)6.0) &&
            is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)5.0) && is_equal(v.w, (T)7.0))
            return 0;
    }
    else if (vTestCode.find(".Vec4.post--") != std::string::npos)
    {
        const auto &vc = v--;
        if (is_equal(vc.x, (T)5.0) && is_equal(vc.y, (T)2.0) && is_equal(vc.z, (T)4.0) && is_equal(vc.w, (T)6.0) &&
            is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)3.0) && is_equal(v.w, (T)5.0))
            return 0;
    }
    else if (vTestCode.find(".Vec4.pre++") != std::string::npos)
    {
        const auto &vc = ++v;
        if (is_equal(vc.x, (T)6.0) && is_equal(vc.y, (T)3.0) && is_equal(vc.z, (T)5.0) && is_equal(vc.w, (T)7.0) &&
            is_equal(v.x, (T)6.0) && is_equal(v.y, (T)3.0) && is_equal(v.z, (T)5.0) && is_equal(v.w, (T)7.0))
            return 0;
    }
    else if (vTestCode.find(".Vec4.pre--") != std::string::npos)
    {
        const auto &vc = --v;
        if (is_equal(vc.x, (T)4.0) && is_equal(vc.y, (T)1.0) && is_equal(vc.z, (T)3.0) && is_equal(vc.w, (T)5.0) &&
            is_equal(v.x, (T)4.0) && is_equal(v.y, (T)1.0) && is_equal(v.z, (T)3.0) && is_equal(v.w, (T)5.0))
            return 0;
    }
    else if (vTestCode.find(".Vec4.+=a") != std::string::npos)
    ...
    {
        bool vb =
            (v != ct::vec4<T>((T)6.0, (T)2.0, (T)6.0, (T)2.0)) && (v != ct::vec4<T>((T)5.0, (T)3.0, (T)6.0, (T)2.0)) &&
...
{
    if (ct::EncodeId("lgfkhklfgjhlgkfkjfghlkfgh") != 0)
    {             // more than 8
        return 1; // error
    }
    if (ct::EncodeId("") != 0)
