...
class example_t
{
    public:
        ...
        std::vector< std::vector< std::vector< std::vector< std::vector< float > > > > > complexNestedArray;
...
int example_t::_encodeNoHash(void* buf, uint32_t offset, uint32_t maxlen) const
{
    ...
    for (int a0 = 0; a0 < 5; ++a0) {
        for (int a1 = 0; a1 < this->nExamples1; ++a1) {
            for (int a2 = 0; a2 < 3; ++a2) {
                for (int a3 = 0; a3 < this->nExamples2; ++a3) {
                    thislen = __float_encode_array(buf, offset + pos_byte, maxlen - pos_byte, &this->complexNestedArray[a0][a1][a2][a3][0], 4);
                    if(thislen < 0) return thislen; else pos_byte += thislen;
                }
            }
        }
...
int example_t::_decodeNoHash(const void* buf, uint32_t offset, uint32_t maxlen)
{
    ...
    this->complexNestedArray.resize(5);
    for (int a0 = 0; a0 < 5; ++a0) {
        this->complexNestedArray[a0].resize(this->nExamples1);
        for (int a1 = 0; a1 < this->nExamples1; ++a1) {
            this->complexNestedArray[a0][a1].resize(3);
            for (int a2 = 0; a2 < 3; ++a2) {
                this->complexNestedArray[a0][a1][a2].resize(this->nExamples2);
                for (int a3 = 0; a3 < this->nExamples2; ++a3) {
                    this->complexNestedArray[a0][a1][a2][a3].resize(4);
                    thislen = __float_decode_array(buf, offset + pos_byte, maxlen - pos_byte, &this->complexNestedArray[a0][a1][a2][a3][0], 4);
                    if(thislen < 0) return thislen; else pos_byte += thislen;
                }
            }
        }
...
uint32_t example_t::_getEncodedSizeNoHash() const
{
    ...
    enc_size += 5 * this->nExamples1 * 3 * this->nExamples2 * __float_encoded_array_size(NULL, 4);
...
uint64_t example_t::_computeHash(const __zcm_hash_ptr* p)
{
    ...
    uint64_t hash = (uint64_t)0x716e95ce60e5e3fbLL +
